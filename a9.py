...
frase.count('o') #contar quantas vezes aparece o 'o' minúscula
frase.count('o',0,13) #contagem com fatiamento, do zero até o treze em incluí-lo contanto os 'o'
...
frase.replace('Python','Android') # substitiu a primeira palavra pela segunda se a primeira existir
...
#print(frase.split()) # cria uma lista com o split, q é uma separador de espaços
'''
